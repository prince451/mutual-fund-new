		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="login-card card-block">
				  ...
				  <form action="login-auth/login-process.php" method="post">
					...
					<div class="text-center">
						...
						<div class="row">
							<div class="col-xs-10 offset-xs-1">
								<button type="submit" name="submit"  class="btn btn-primary btn-md btn-block waves-effect waves-light m-b-20">LOGIN
                                 </button>
							</div>
						</div>
